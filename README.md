<p align="center">
  <img src="assets/logo.png" width="128" alt="scope">
</p>
...
│   ├── selfdrive/ui/
│   │   ├── ui_state.dart                  # UIState ChangeNotifier, 20Hz throttle
│   │   └── onroad/
...
│   ├── services/
│   │   ├── discovery_service.dart         # mDNS/NSD auto-discovery (Bonjour)
│   │   ├── telemetry_parser.dart          # }{ split, NaN sanitize, JSON decode
│   │   ├── connection_manager.dart        # Discovery → WebRTC → parse → dispatch
